...
### Fixed
* Fixed Custom Filter not allowing "/" characters in the "Extra Data" string

## [26.1.2.2]

### Fixed
* Fixed `FTBFilterSystemEvent.CustomFilter#getOutcome()` wrongly returning `null` on NeoForge
